...
mkdir -p $GOPATH/src/github.com/anchnet
cd $GOPATH/src/github.com/anchnet
git clone https://github.com/anchnet/graph.git
...
你可以从[这里](https://github.com/anchnet/graph/releases)，下载最新的release安装包，避免源码编译的种种问题。
